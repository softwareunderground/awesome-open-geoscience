...
- [seismic-zfp](https://github.com/equinor/seismic-zfp) – ![Python](media/icon/python.png) Python library to convert SEG-Y files to compressed cubes and retrieve arbitrary sub-volumes from these, fast.
