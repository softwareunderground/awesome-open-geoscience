...
- [GSQ Open Data Portal](https://geoscience.data.qld.gov.au/) – Open Petroleum, Coal, and Mineral geoscience data from the resource industry and government, provisioned by the Geological Survey of Queensland. Supplemented by background information from [GSQ GitHub Repository](https://github.com/geological-survey-of-queensland) for Data Models, RDF Vocabularies, and system design.
